...
\textbf{Main takeaway: Memory appears to be required for good performance but bias doesn't make a difference.}
...
\begin{figure}[!tbp]
  \centering
  % RNN no-bias 3HL
  \subfloat{\includegraphics[width=0.3\textwidth]{3_layers/3_layers_score_trials_ordered_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{3_layers/3_layers_variance_meanscore_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{3_layers/3_layers_all_scores_log_dist_.png}}
  
  % RNN no-bias 4HL
  \subfloat{\includegraphics[width=0.3\textwidth]{4_layers/4_layers_score_trials_ordered_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{4_layers/4_layers_variance_meanscore_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{4_layers/4_layers_all_scores_log_dist_.png}}

  % RNN no-bias 5HL
  \subfloat{\includegraphics[width=0.3\textwidth]{5_layers/5_layers_score_trials_ordered_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{5_layers/5_layers_variance_meanscore_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{5_layers/5_layers_all_scores_log_dist_.png}}

  % RNN no-bias 6HL
  \subfloat{\includegraphics[width=0.3\textwidth]{6_layers/6_layers_score_trials_ordered_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{6_layers/6_layers_variance_meanscore_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{6_layers/6_layers_all_scores_log_dist_.png}}

  % RNN no-bias 7HL
  \subfloat{\includegraphics[width=0.3\textwidth]{7_layers/7_layers_score_trials_ordered_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{7_layers/7_layers_variance_meanscore_.png}}
  \hfill
  \subfloat{\includegraphics[width=0.3\textwidth]{7_layers/7_layers_all_scores_log_dist_.png}}
