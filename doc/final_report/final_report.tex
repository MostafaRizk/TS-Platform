...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{experiment_2.1/preliminary_magic_plot_reevaluated.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{experiment_2.1/preliminary_magic_plot_reevaluated_spec.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{experiment_2.1/preliminary_magic_plot_distributions.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{experiment_2.1/preliminary_magic_plot_distributions_spec.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{experiment_2.1/preliminary_evolutionary_history.png}
...
\begin{tabularx}{1.5\textwidth}{|X|X|X|X|X|}
\hline
  & \textbf{Generalist} & \textbf{Dropper} & \textbf{Collector}& \textbf{Novice}\\
\thickhline
\textbf{Generalist} 
& \makecell{ $g - sc$, \\ $g - sc$ } 
& \makecell{$g - sc$, \\ $s \theta(s) f + (1-\theta(s)) b$} 
& \makecell{$g - sc$, \\ $b$} 
& \makecell{$g - sc$, \\ $s \theta(s) f + (1-\theta(s)) b$} \\
\hline
\textbf{Dropper} 
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $g - sc$} 
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $s \theta(s) f + (1-\theta(s)) b$} 
& \makecell{$s \theta(s) e + (1-\theta(s)) b$, \\ $s \theta(s) e + (1-\theta(s)) b$}
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $s \theta(s) f + (1-\theta(s)) b$} \\
\hline
\textbf{Collector} 
& \makecell{$b$, \\ $g - sc$} 
& \makecell{$s \theta(s) e + (1-\theta(s)) b$, \\ $s \theta(s) e + (1-\theta(s)) b$} 
& \makecell{$b$, \\ $b$} 
& \makecell{$b$, \\ $s \theta(s) f + (1-\theta(s)) b$} \\
\hline
\textbf{Novice} 
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $g - sc$} 
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $(s \theta(s) f + (1-\theta(s)) b$} 
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $b$} 
& \makecell{$s \theta(s) f + (1-\theta(s)) b$, \\ $(s \theta(s) f + (1-\theta(s)) b$} \\
\hline
\end{tabularx}}
\end{center}
