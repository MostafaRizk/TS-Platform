...
class CentralisedRWGLearner(CentralisedLearner):
    ...
    def learn(self, logging=True):
        ...
        agent_fitness_lists, team_specialisations, agent_bc_vectors = self.fitness_calculator.calculate_fitness_of_agent_population(agent_population, self.calculate_specialisation)
