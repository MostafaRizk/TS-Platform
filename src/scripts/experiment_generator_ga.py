...
def generate_ga_experiments(experiment_directory, core_parameter_filename, learning_type, reward_level, list_file_name, num_agents_in_setup, holding_constant, num_seeds_for_team, generator_seed):
    ...
    for num_agents in num_agents_in_setup:
        ...
        for i in range(num_experiments):
            ...
            parameters_in_filename += GALearner.get_additional_params_in_model_name(parameter_dictionary)
...
generate_ga_experiments(experiment_directory, core_parameter_filename, learning_type, reward_level, list_file_name, num_agents_in_setup, holding_constant, num_seeds_for_team, generator_seed)
