...
do
  ...
  # Fitness plots
  python3 plot_scalability.py --results_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/data/$results_file --graph_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/analysis/magic_plot_reeval_${episodes}_error_RCoop_no_CTDE.pdf --plot_type error --max_agents 8 --violin False --y_height_min -10000 --y_height_max 20000 --showing fitness

  # Spec plots
  python3 plot_scalability.py --results_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/data/$results_file --graph_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/analysis/magic_plot_reeval_${episodes}_spec_RCoop_no_CTDE.pdf --plot_type error --max_agents 8 --violin False --showing specialisation
  ...
  #---
  #python3 plot_episodes.py --results_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/data/$results_file --graph_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/analysis/episode_rollout_${episodes}_episodes_full_RCoop_left_no_CTDE.pdf --min_agents 2 --max_agents 2 --y_height 30000 --exclude_middle_plots True --remove_CTDE True
  #python3 plot_episodes.py --results_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/data/$results_file --graph_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/analysis/episode_rollout_${episodes}_episodes_full_RCoop_right_no_CTDE.pdf --min_agents 8 --max_agents 8 --y_height 30000 --exclude_middle_plots True --remove_CTDE True
  #python3 plot_episodes.py --results_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/data/$results_file --graph_path /Users/mostafa/Documents/Code/PhD/TS-Platform/results/$folder_name/analysis/episode_rollout_${episodes}_episodes_full_RCoop_all.pdf --min_agents 2 --max_agents 8 --y_height 30000 --exclude_middle_plots False
