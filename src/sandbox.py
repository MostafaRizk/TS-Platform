        ...
        for bias in biases:
            for m in metrics:
                for arch in ["FFNN", "RNN"]:
                    ...
                    plot_envs_vs_NN_arch(genome_directory, bias, N_bins=list(range(-5000, 55000, 10000)), mean_lim=(-5000, 55000), var_mean_lim=(-5000, mean_upper), var_lim=(0, var_upper), dist_lim=(10 ** -1, 20000), spec_metric_key=m, num_samples=10000, num_episodes=20, env="slope", learning_type=learning_type, arch=arch)
